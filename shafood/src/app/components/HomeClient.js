              ...
              >
                <ul className="flex flex-col space-y-2">
                  <li>
                    <Link
                      href="#how-it-works"
                      className="block py-2 px-4 text-orange-600 hover:bg-orange-100 rounded"
          ...
          <main className="container mx-auto px-4 py-16 relative z-[1]">
            ...
            >
              ...
              <p className="text-xl mb-10 max-w-2xl mx-auto text-gray-700">
                ShaFood helps you save on delivery charges by ordering together
                with nearby users. Join our community and start saving today!
              </p>
            ...
            <section id="how-it-works" className="mb-24">
              <h2 className="text-4xl font-bold mb-12 text-orange-600 text-center">
                How It Works
              </h2>
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                <AnimatePresence mode="wait">
                  {steps.map((step, index) => (
                    <Suspense
                      key={index}
                      fallback={<Loader size="h-32 w-32" />}
                    >
                      <StepCard
                        step={index + 1}
                        title={step.title}
