...
import { faUtensils, faUsers, faMapMarkerAlt, faEnvelope, faBars, faTimes, faFileAlt } from '@fortawesome/free-solid-svg-icons'
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="flex flex-col md:flex-row space-y-2 md:space-y-0 md:space-x-4">
              ...
              <Link href="/terms" className="flex items-center hover:text-orange-200 transition-colors duration-300">
